...
def build_ydl_options(temp_dir, log_capture, url, use_cookies=True):
...
def _download_once(url, temp_dir, log_capture, use_cookies=True):
        ...
        if is_instagram(url):
            ...
            try:
                ...
                log_capture.lines.append(
                    'Instagram cookie attempt failed: ' + str(first_error)
                )
                extracted = None
