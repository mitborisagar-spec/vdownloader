...
def extract_video_url(url):
    ...
    with yt_dlp.YoutubeDL(ydl_opts) as ydl:
        ...
        debug = None
        if not video_url:
            # Filter the captured yt-dlp debug log for the lines that
            # actually matter - PO Token provider status and any
            # pot-related warnings/errors.
            relevant_logs = [
            ...
            debug = {
                ...
                'pot_related_logs': relevant_logs[:30],
                'sample': [
                    {
